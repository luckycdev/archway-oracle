...
YOLO_DETECTION_MIN_INTERVAL_SECONDS = max(0.0, _get_float("YOLO_DETECTION_MIN_INTERVAL_SECONDS", 0.15))
...
STREAM_PLAYBACK_DELAY_SECONDS = max(0.0, _get_float("STREAM_PLAYBACK_DELAY_SECONDS", 2.0))
STREAM_OUTPUT_FPS = max(1.0, _get_float("STREAM_OUTPUT_FPS", 8.0))
STREAM_HISTORY_MAX_FRAMES = max(30, _get_int("STREAM_HISTORY_MAX_FRAMES", 240))
